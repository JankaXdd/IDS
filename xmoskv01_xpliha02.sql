...
-- Dva triggery
    ...
    BEGIN
        ...
        IF datum_a_cas < SYSTIMESTAMP THEN
    ...
    SELECT * FROM Navsteva;
        INSERT INTO Navsteva (datum, cas, rodneCislo)
        VALUES (TO_DATE('2024-04-28', 'YYYY-MM-DD'), TO_DATE('23:20:00', 'HH24:MI:SS'), 6202229990);
    SELECT * FROM Navsteva;
    --DELETE FROM Navsteva WHERE idNavstevy = xxxxxxxxxxxx;
    */
